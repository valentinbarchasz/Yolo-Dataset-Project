...
PATH_TO_MODEL_DIR = 'exported-models/my_model' #download_model(MODEL_NAME, MODEL_DATE)
...
PATH_TO_LABELS = 'annotations/label_map.pbtxt' #download_labels(LABEL_FILENAME)
