...
tflite_model_quant_file = 'exported-models/my_modelpretrain/tflite/saved_model_quantized_8bit.tflite'
saved_model_dir='exported-models/my_modelpretrain/tflite/saved_model'
